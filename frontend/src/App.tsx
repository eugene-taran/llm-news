...
function App() {
    ...
    useEffect(() => {
        ...
        script.text = JSON.stringify({
            ...
            "@type": "WebSite",
            "name": "LLM News by DevEugene",
            "alternateName": "LLM News DevEugene",
            "url": "https://deveugene.github.io/llm-news/",
            "description": "Daily trending news summaries generated by multiple AI models including Gemini, GPT-4, and Claude. Compare how different LLMs interpret today's top stories.",
            "author": {
                "@type": "Person",
                "name": "DevEugene"
            },
            ...
            "inLanguage": "en-US",
            "keywords": "llm news, deveugene, ai news, gpt-4 news, gemini news, claude news, ai trends, daily news aggregation",
            "potentialAction": {
                "@type": "SearchAction",
                "target": {
                    "@type": "EntryPoint",
                    "urlTemplate": "https://deveugene.github.io/llm-news/#/{date}"
                },
